    ...
    public function store(Request $request)
    {
        ...
        $rules = [
          ...
          //  'purchase_order_date'=>'date_format:Y-m-d H:i:s',
            ...
            'payment_status_id' => 'required|integer|exists:conf_statuses,id',
    ...
    public function update(Request $request, StockTracker $stockTracker)
    {
        ...
        if($request->method()=='PATCH'){
            $rules = [
                ...
                'order_type_id' => 'sometimes|required|integer|exists:order_types,id',
              ...
              //  'purchase_order_date'=>'date_format:Y-m-d H:i:s',
                ...
                'payment_status_id' => 'sometimes|required|integer|exists:conf_statuses,id',
