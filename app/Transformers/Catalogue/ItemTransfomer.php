    ...
    public function transform(Item $model)
    {
       if($model->supplier_id==Null || (int)$model->supplier_id==0)
       {
        ...
        return [
            ...
            'min_order_amount'=> number_format((double) $model->min_order_amount, '.', ''),
            'max_order_quantity'=>(int) $model->max_order_quantity,
            'max_order_amount'=> number_format((double) $model->max_order_amount,2),
            'discount_percentage'=> number_format((double) $model->discount_percentage,2),
            'discount_amount'=> number_format((double) $model->discount_amount,2),
            ...
            'MRP'=>number_format((double)$model->MRP,2),
            'selling_price'=>number_format((double)$model->selling_price,2),
